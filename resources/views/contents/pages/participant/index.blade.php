                                        ...
                                        <div class="flex items-center justify-between">
                                            ...
                                            @auth
                                                ...
                                                <div class="flex-shrink-0 ml-2">
                                                    @if($participant->is_public)
                                                        <div class="bg-green-500 bg-opacity-20 text-green-200 px-2 py-1 rounded-full text-xs flex items-center" 
                                                    ...
                                                    @else
                                                        <div class="bg-red-500 bg-opacity-20 text-red-200 px-2 py-1 rounded-full text-xs flex items-center" 
