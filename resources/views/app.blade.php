...
<head>
    ...
    <title>PT Rizaldi Bina Bersama</title>
                ...
                <div class="hidden lg:flex items-center space-x-6">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" 
                            ...
                            <div class="py-1">
                                <a href="{{ url('/lang/en') }}" 
                                   class="flex items-center space-x-3 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 {{ session('applocale', 'en') === 'en' ? 'bg-gray-50 font-medium' : '' }}">
                                    <span class="w-5 h-5 rounded-sm overflow-hidden">
                                        <svg viewBox="0 0 24 24" class="w-full h-full">
                                            <rect width="24" height="24" fill="#012169"/>
                                            <path d="M0 0l24 24M24 0L0 24" stroke="#fff" stroke-width="2.5"/>
                                            <path d="M12 0v24M0 12h24" stroke="#fff" stroke-width="4"/>
                                            <path d="M12 0v24M0 12h24" stroke="#C8102E" stroke-width="2"/>
                                        </svg>
                                    </span>
                                    <span>English</span>
                                    @if(session('applocale', 'en') === 'en')
                                ...
                                <a href="{{ url('/lang/zh') }}" 
                                   class="flex items-center space-x-3 px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 {{ session('applocale') === 'zh' ? 'bg-gray-50 font-medium' : '' }}">
                                    <span class="w-5 h-5 rounded-sm overflow-hidden">
                                        <svg viewBox="0 0 24 24" class="w-full h-full">
                                            <rect width="24" height="24" fill="#DE2910"/>
                                            <polygon points="3,4 4.5,7 1.5,7" fill="#FFDE00"/>
                                            <polygon points="6,3 6.5,4.5 5.5,4.5" fill="#FFDE00"/>
                                            <polygon points="7,5 7.5,6.5 6.5,6.5" fill="#FFDE00"/>
                                            <polygon points="7,7 7.5,8.5 6.5,8.5" fill="#FFDE00"/>
                                            <polygon points="6,9 6.5,10.5 5.5,10.5" fill="#FFDE00"/>
                                        </svg>
                                    </span>
                                    <span>中文</span>
                                    @if(session('applocale') === 'zh')
